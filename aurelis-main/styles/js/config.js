...
charadex.sheet = {
  ...
  id: "1MYyVZLHppfi9n6pnR8hMUzE1imlzQ52PRLFJAZ9hB_M",
  ...
  options: {
    ...
    Magic: ['All', 'Life', 'Elements', 'Psyche', 'Blend', 'Unknown'],
    statuses: ['All', 'Active', 'Dead', 'Unknown'],
    rarity: ['All', 'Worn', 'Used', 'Faithful', 'Auric'],
    Type: ['All', 'Fools Gold', 'Herrings Call', 'NPC', 'Deity' ],
...
/* Equipment
/* --------------------------------------------------------------- */
charadex.page.equipment = {

  sheetPage: charadex.sheet.pages.equipment,
  sitePage: 'equipment',
  dexSelector: 'charadex',
  profileProperty: 'equipment',
...
charadex.page.masterlist = {
  ...
  filters: {
    toggle: true,
    parameters: {
      'Magic': charadex.sheet.options.Magic,
  ...
  fauxFolder: {
    toggle: true,
    folderProperty: 'Type',
    parameters: charadex.sheet.options.type,
  },

  search: {
    toggle: true,
    filterToggle: true,
    parameters: ['Design', 'Owner']
  },
